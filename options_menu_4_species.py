...
class OptionsMenu_4_species(QtWidgets.QWidget):
   ...
   # = QtWidgets.QDoubleSpinBox()
        ...
        coeff_grid.addWidget(QtWidgets.QLabel('Убийства жертв вида 1 хищниками'), 1, 0)
        coeff_grid.addWidget(self.a11_sb, 1, 1)

        coeff_grid.addWidget(QtWidgets.QLabel('Рождаемость жертв вида 2'), 2, 0)
        coeff_grid.addWidget(self.b2_sb, 2, 1)
        coeff_grid.addWidget(QtWidgets.QLabel('Убийства жертв вида 2 хищниками'), 3, 0)
        coeff_grid.addWidget(self.a12_sb, 3, 1)

        coeff_grid.addWidget(QtWidgets.QLabel('Рождаемость жертв вида 3'), 4, 0)
        coeff_grid.addWidget(self.b3_sb, 4, 1)
        coeff_grid.addWidget(QtWidgets.QLabel('Убийства жертв вида 2 хищниками'), 5, 0)
        coeff_grid.addWidget(self.a13_sb, 5, 1)

        coeff_grid.addWidget(QtWidgets.QLabel('Смертность хищников вида от голода'), 6, 0)
        coeff_grid.addWidget(self.b4_sb, 6, 1)
        coeff_grid.addWidget(QtWidgets.QLabel('Прирост хищников за счёт убийства жертв вида 1'), 7, 0)
        coeff_grid.addWidget(self.a21_sb, 7, 1)
        coeff_grid.addWidget(QtWidgets.QLabel('Прирост хищников за счёт убийства жертв вида 2'), 8, 0)
  ...
  #      self.superpredator_sb.setSingleStep(1)
        ...
        self.prey3_sb = QtWidgets.QDoubleSpinBox()
        self.prey3_sb.setRange(0, 100000)
        self.prey3_sb.setSingleStep(1)
