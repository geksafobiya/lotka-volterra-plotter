...
class OptionsMenu_4_species(QtWidgets.QWidget):
   ...
   # = QtWidgets.QDoubleSpinBox()
        ...
        coeff_grid.addWidget(QtWidgets.QLabel('Рождаемость жертв вида'), 0, 0)
        coeff_grid.addWidget(self.b1_sb, 0, 1)
        coeff_grid.addWidget(QtWidgets.QLabel('Убийства жертв хищниками вида 1'), 1, 0)
        coeff_grid.addWidget(self.a11_sb, 1, 1)

        coeff_grid.addWidget(QtWidgets.QLabel('Смертность хищников вида 1'), 2, 0)
        coeff_grid.addWidget(self.b2_sb, 2, 1)
        coeff_grid.addWidget(QtWidgets.QLabel('Убийства жертв хищниками вида 2'), 3, 0)
        coeff_grid.addWidget(self.a12_sb, 3, 1)

        coeff_grid.addWidget(QtWidgets.QLabel('Смертность хищников вида 2'), 4, 0)
        coeff_grid.addWidget(self.b3_sb, 4, 1)
        coeff_grid.addWidget(QtWidgets.QLabel('Убийства жертв хищниками вида 3 '), 5, 0)
        coeff_grid.addWidget(self.a13_sb, 5, 1)

        coeff_grid.addWidget(QtWidgets.QLabel('Смертность хищников вида 3 от голода'), 6, 0)
        coeff_grid.addWidget(self.b4_sb, 6, 1)
        coeff_grid.addWidget(QtWidgets.QLabel('Прирост хищников  вида 1 за счёт убийства жертв'), 7, 0)
        coeff_grid.addWidget(self.a21_sb, 7, 1)
        coeff_grid.addWidget(QtWidgets.QLabel('Прирост хищников  вида 2 за счёт убийства жертв'), 8, 0)
        coeff_grid.addWidget(self.a22_sb, 8, 1)
        coeff_grid.addWidget(QtWidgets.QLabel('Прирост хищников  вида 3 за счёт убийства жертв'), 9, 0)
  ...
  #      self.superpredator_sb.setSingleStep(1)
        ...
        other_grid.addWidget(QtWidgets.QLabel('Популяция хищников вида 3'), 2, 0)
 ...
 #       other_grid.addWidget(QtWidgets.QLabel('Популяция суперхищников'), 1, 0)
  #      other_grid.addWidget(self.superpredator_sb, 1, 1)
      ...
      #  other_grid.addWidget(QtWidgets.QLabel('Популяция жертв вида 3'), 4, 0)
      #  other_grid.addWidget(self.prey3_sb, 4, 1)
