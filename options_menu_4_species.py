...
class OptionsMenu_4_species(QtWidgets.QWidget):
   ...
   # = QtWidgets.QDoubleSpinBox()
        ...
        for widget in (self.b1_sb, self.a11_sb, self.a12_sb,
                       ...
                       self.b3_sb, self.a23_sb, self.a31_sb,
                       self.b4_sb):
            widget.setRange(0, 1)
        ...
        coeff_grid.addWidget(QtWidgets.QLabel('Смертность хищников вида от голода'), 4, 0)
        coeff_grid.addWidget(self.b3_sb, 4, 1)
        coeff_grid.addWidget(QtWidgets.QLabel('Прирост хищников за счёт убийства жертв вида 1'), 5, 0)
        coeff_grid.addWidget(self.a21_sb, 5, 1)
        coeff_grid.addWidget(QtWidgets.QLabel('Прирост хищников за счёт убийства жертв вида 2'), 6, 0)
        coeff_grid.addWidget(self.a22_sb, 6, 1)
        coeff_grid.addWidget(QtWidgets.QLabel('Убийства хищников суперхиниками'), 7, 0)
