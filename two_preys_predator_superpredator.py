...
class GrowthCalculator(object):
    def __init__(self):
        ...
        self.a14 = 0.1  # смерть от хищников
        #для хищников
        ...
        self.a31 = 0.075 #репродукция хищников за каждого съеденного
        self.a32 = 0.5 #смертность от старости
        self.a33 = 0.5  # смертность от старости
        # Other parameters
        self.dt = 0.02
        self.iterations = 1000
        self.predators = 5
        self.superpredators = 5
        self.prey1 = 10
        self.prey2 = 10
    ...
    def dx1(self, x1, x2, y, z):
        ...
        dx1_dt = x1 * (self.b1 - self.a11*y - self.a12*z)
        return dx1_dt
    ...
    def dx2(self, x1, x2, y, z):
        ...
        dx2_dt = x2 * (self.b2 - self.a13*y - self.a14*z)
    ...
    def dz(self, x1, x2, y, z):
        ...
        # Calculate the rate of population change
        dz_dt = z * (-self.b4 + self.a31*x1 + self.a32*x2 + self.a33*y)
    ...
    def calculate(self):
        ...
        y0 = np.array([self.prey1, self.prey2, self.predators, self.superpredators], dtype='double')
