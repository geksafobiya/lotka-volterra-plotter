...
class OptionsMenu_2_species(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        coeff_grid.addWidget(QtWidgets.QLabel('Вбивства жертв хижаками'), 1, 0)
        coeff_grid.addWidget(self.a11_sb, 1, 1)

        coeff_grid.addWidget(QtWidgets.QLabel('Приріст хижаків за рахунок жертв'), 2, 0)
        coeff_grid.addWidget(self.a21_sb, 2, 1)

        coeff_grid.addWidget(QtWidgets.QLabel('Смертність хижаків від голоду'), 3, 0)
